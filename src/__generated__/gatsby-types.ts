...
type BlogHTMLQueryVariables = Exact<{
  slug: Scalars['String'];
}>;


type BlogHTMLQuery = { readonly markdownRemark: Maybe<(
...
type BlogListQuery = { readonly allMarkdownRemark: (
...
type MyFilesQuery = { readonly allFile: { readonly edges: ReadonlyArray<{ readonly node: Pick<File, 'relativePath' | 'prettySize' | 'extension' | 'birthTime'> }> } };
